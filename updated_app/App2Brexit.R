...
setwd("~/Documents/Brexit_Analysis/updated_app/")
source('initialize_Brexit.R')
...
ui <- navbarPage("Brexit Data Visualization",
                 ...
                 #Scatter plot
                 #==================
                 tabPanel(span("Time-series" , style = "color:#1369bf"), fluidPage(
                   ...
                   fluidRow(
                     ...
                     column(4, tabsetPanel(
                       tabPanel("Axes", wellPanel( #RENAME PANEL TAB
                         ...
                         #Sliders for year
                         sliderInput("ScatterYear", "Wave of Survey", 1, 20, 
                                     value = c(1, 20), sep=""),
...
server <- function(input, output, clientData, session) {
  ...
  filterDataReactive <- reactive({
    ...
    #By years
    filteredGTD <- filteredGTD[filteredGTD$wave >= input$ScatterYear[1] & 
